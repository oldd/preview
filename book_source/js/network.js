...
var nodes = new vis.DataSet([
    ...
    {id: 03,    label: 'git and Hub', title: 'tools for sharing, collaborating, and preserving \n -- in progress --',
                ...
                level: 1, x: -350, y: 100 },
    {id: 04,    label: 'understanding problems', title: 'solving problems is for noobs, real developers understand them \n -- in progress --',
                group: 'md',
    ...
    {id: 07,    label: 'specs', title: 'how developers talk about code \n -- in progress --',
                ...
                level: 1, x: -200, y: -100 },
    {id: 08,    label: 'user stories', title: 'keeping the user in mind from step 0 \n -- in progress --',
                group: 'md',
    ...
    {id: 09,    label: 'testing 101', title: 'just the basics, all the basics \n -- in progress --',
                ...
                level: 1, x: -100, y: -150 },
    {id: 10,    label: 'testing objects', title: 'testing objects is not the same as testing functions \n -- in progress --',
                group: 'md',
